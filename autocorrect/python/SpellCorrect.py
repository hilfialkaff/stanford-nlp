...
from GoodTuringSmoothingModel import GoodTuringSmoothingModel
...
def main():
  ...
  print 'Good-Turing Smoothing Language Model: '
  goodTuringSmoothingLM = GoodTuringSmoothingModel(trainingCorpus)
  goodTuringSmoothingSpell = SpellCorrect(goodTuringSmoothingLM, trainingCorpus)
  goodTuringSmoothingOutcome = goodTuringSmoothingSpell.evaluate(devCorpus)
  print str(goodTuringSmoothingOutcome)
